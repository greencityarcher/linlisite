<?php
	...
	function userpro_default_options(){
		...
		$mail_password_change.= __('If you have any problems, please contact us at {USERPRO_ADMIN_EMAIL}.','userpro') . "\r\n\r\n";
		$mail_password_change .= __('Best Regards!','userpro');
		$mail_secretkey = __('Hi there,') . "\r\n\r\n";
		$mail_secretkey .= __("You or someone else has requested to change password for this account.","userpro") . "\r\n\r\n";
		$mail_secretkey .= __("The following key was generated to you to be able to change your passsword. Login to our site and attempt to Change your Password and use that key to change your password successfully.","userpro") . "\r\n\r\n";
		$mail_secretkey .= __('Secret Key: {VAR1}','userpro') . "\r\n\r\n";
		$mail_secretkey .= __('If you have any problems, please contact us at {USERPRO_ADMIN_EMAIL}.','userpro') . "\r\n\r\n";
		$mail_secretkey .= __('Best Regards!','userpro');
		
		$mail_verifyemail = __('Hi there,') . "\r\n\r\n";
		$mail_verifyemail .= __("Thanks for signing up at {USERPRO_BLOGNAME}. You must confirm/validate your account before logging in.","userpro") . "\r\n\r\n";
		$mail_verifyemail .= __("Please click on the following link to successfully activate your account:","userpro") . "\r\n";
		$mail_verifyemail .= "{USERPRO_VALIDATE_URL}" . "\r\n\r\n";
		$mail_verifyemail .= __('If you have any problems, please contact us at {USERPRO_ADMIN_EMAIL}.','userpro') . "\r\n\r\n";
		$mail_verifyemail .= __('Best Regards!','userpro');
		
		$mail_verifyemail_change = __('Hi there,') . "\r\n\r\n";
		$mail_verifyemail_change .= __("You have changed your email address at {USERPRO_BLOGNAME}. You must confirm/validate your account before logging in.","userpro") . "\r\n\r\n";
		$mail_verifyemail_change .= __("Please click on the following link to successfully activate your account:","userpro") . "\r\n";
		$mail_verifyemail_change .= "{USERPRO_VALIDATE_URL}" . "\r\n\r\n";
		$mail_verifyemail_change .= __('If you have any problems, please contact us at {USERPRO_ADMIN_EMAIL}.','userpro') . "\r\n\r\n";
		...
		$mail_newaccount .= __('If you have any problems, please contact us at {USERPRO_ADMIN_EMAIL}.','userpro') . "\r\n\r\n";
		...
		$mail_verifyinvite .= __("To accept this invitation and get verified instantly, please click the following link:","userpro") . "\r\n";
		$mail_verifyinvite .= "{USERPRO_ACCEPT_VERIFY_INVITE}" . "\r\n\r\n";
		$mail_verifyinvite .= __('If you do not want to GET VERIFIED, please ignore this email. No further action is required.','userpro') . "\r\n\r\n";
		$mail_verifyinvite .= __('If you have any further questions, please contact us at {USERPRO_ADMIN_EMAIL}.','userpro') . "\r\n\r\n";
		...
		$mail_accountdeleted .= __('If you have any further questions, please contact us at {USERPRO_ADMIN_EMAIL}.','userpro') . "\r\n\r\n";
		...
		$mail_accountverified .= __('If you have any further questions, please contact us at {USERPRO_ADMIN_EMAIL}.','userpro') . "\r\n\r\n";
		$mail_accountverified .= __('Best Regards!','userpro');
		
		$mail_accountunverified = __('Hi there,') . "\r\n\r\n";
		$mail_accountunverified .= __("We apologize. Your account is no longer verified at {USERPRO_BLOGNAME}.","userpro") . "\r\n\r\n";
		$mail_accountunverified .= __('If you have any further questions, please contact us at {USERPRO_ADMIN_EMAIL}.','userpro') . "\r\n\r\n";
		...
		$mail_accountblocked .= __('If you have any query, please contact us at {USERPRO_ADMIN_EMAIL}.','userpro') . "\r\n\r\n";
		...
		$mail_accountunblocked .= __('If you have any query, please contact us at {USERPRO_ADMIN_EMAIL}.','userpro') . "\r\n\r\n";
		$mail_accountunblocked .= __('Best Regards!','userpro');
		
		$pending_for_admin_approval_txt = __('Hi there,') . "\r\n\r\n";
		$pending_for_admin_approval_txt.= __("Your account is currently being reviewed at {USERPRO_BLOGNAME}.","userpro") . "\r\n\r\n";
		$pending_for_admin_approval_txt .= __('If you have any query, please contact us at {USERPRO_ADMIN_EMAIL}.','userpro') . "\r\n\r\n";
		$pending_for_admin_approval_txt .= __('Best Regards!','userpro');		

		$mail_admin_pendingapprove = __('Hi there,') . "\r\n\r\n";
		$mail_admin_pendingapprove .= __("{USERPRO_USERNAME} has just created a new account at {USERPRO_BLOGNAME}. The account is pending your manual review.","userpro") . "\r\n\r\n";
		$mail_admin_pendingapprove .= __("To approve/reject new user registrations, please click the following link:","userpro") . "\r\n";
		$mail_admin_pendingapprove .= "{USERPRO_PENDING_REQUESTS_URL}" . "\r\n\r\n";
		$mail_admin_pendingapprove .= __('This is an automated notification that was sent to you by UserPro. No further action is needed.','userpro');
		
		$mail_admin_verify_requests=__('Hi there,') . "\r\n\r\n";
		$mail_admin_verify_requests .= __("{USERPRO_USERNAME} has just sent you account verify request at {USERPRO_BLOGNAME}.","userpro") . "\r\n\r\n";
		...
		$mail_admin_verify_requests .= __('This is an automated notification that was sent to you by UserPro. No further action is needed.','userpro');

		$mail_userpro_connect_request=__('Hi there,') . "\r\n\r\n";
		$mail_userpro_connect_request .= __("{USERPRO_USERNAME} has just sent you connect request at {USERPRO_BLOGNAME}.","userpro") . "\r\n\r\n";
		...
		$mail_userpro_connect_request .= __('This is an automated notification that was sent to you by UserPro. No further action is needed.','userpro');
	
		$mail_admin_newaccount = __('Hi there,') . "\r\n\r\n";
		$mail_admin_newaccount .= __("{USERPRO_USERNAME} has just created a new account at {USERPRO_BLOGNAME}.","userpro") . "\r\n\r\n";
		...
		$mail_admin_newaccount .= __('This is an automated notification that was sent to you by UserPro. No further action is needed.','userpro');
		
		$mail_admin_accountdeleted = __('Hi there,') . "\r\n\r\n";

		$mail_admin_accountdeleted .= __("{USERPRO_USERNAME}'s profile has been just deleted from {USERPRO_BLOGNAME}.","userpro") . "\r\n\r\n";
		$mail_admin_accountdeleted .= __('This is an automated notification that was sent to you by UserPro. No further action is needed.','userpro');
		
		$mail_admin_profileupdate = __('Hi there,') . "\r\n\r\n";
		$mail_admin_profileupdate .= __("{USERPRO_USERNAME} has just updated their profile at {USERPRO_BLOGNAME}.","userpro") . "\r\n\r\n";
		$mail_admin_profileupdate .= __("To view his/her profile:","userpro") . "\r\n";
		$mail_admin_profileupdate .= "{USERPRO_PROFILE_LINK}" . "\r\n\r\n";
		$mail_admin_profileupdate .= __('This is an automated notification that was sent to you by UserPro. No further action is needed.','userpro');
		...
		$mail_verifyemail_admin .= __("{USERPRO_USERNAME} has just created a new account at {USERPRO_BLOGNAME}. The account is pending email verification.","userpro") . "\r\n\r\n";
		$mail_verifyemail_admin .= __('This is an automated notification that was sent to you by UserPro. No further action is needed.','userpro');
		...
		$array['google_redirect_uri'] = add_query_arg('upslug', 'gplus', trailingslashit( esc_url(home_url()) ) );
		...
		$array['restricted_content_text'] = __('You cannot view this content because It is available to members only. Please {LOGIN_POPUP} or {REGISTER_POPUP} to view this area.','userpro');
		$array['verified_link'] = '';
        ...
        $array['mail_verifyemail_admin'] = $mail_verifyemail_admin;
   		$array['mail_verifyemail_waiting_admin'] = __('[UserPro]New Registration - Pending email verification by user','userpro');
		return apply_filters('userpro_default_options_array', $array);
	}
