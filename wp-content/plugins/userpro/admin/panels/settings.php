...
<h3><i class="userpro-icon-wrench"></i><?php _e('Quick Maintenance','userpro'); ?></h3>
<table class="form-table">

	<tr valign="top">
		<th scope="row"><label><?php _e('Clear unused Junk','userpro'); ?></label></th>
		<td>
			<a href="admin.php?page=userpro&tab=settings&userpro_act=clear_unused_uploads" class="button"><?php _e('Clear un-used uploads','userpro'); ?></a>
		</td>
	</tr>
	<tr valign="top">
		<th scope="row"><label><?php _e('Clear Members Cache','userpro'); ?></label></th>
		<td>
			<a href="admin.php?page=userpro&tab=settings&userpro_act=clear_cache" class="button"><?php _e('Clear Members Cache','userpro'); ?></a>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			<a href="admin.php?page=userpro&tab=settings&userpro_act=clear_deleted_users" class="button"><?php _e('Clear deleted users stuff','userpro'); ?></a>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			<a href="admin.php?page=userpro&tab=settings&userpro_act=reset_online_users" class="button"><?php _e('Reset online users','userpro'); ?></a>
			<?php echo count(get_transient('userpro_users_online')); ?> <?php _e('Online','userpro'); ?>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			<a href="admin.php?page=userpro&tab=settings&userpro_act=clear_activity" class="button"><?php _e('Delete all activity','userpro'); ?></a>
		</td>
	</tr>
	
</table>

<h3><i class="userpro-icon-bell"></i><?php _e('Module Settings','userpro'); ?></h3>
<table class="form-table">
		...
		<td>
			<select name="modstate_social" id="modstate_social" class="chosen-select" style="width:300px">
				...
				<option value="0" <?php selected(0, userpro_get_option('modstate_social')); ?>><?php _e('Deactivate','userpro'); ?></option>
                        ...
                        <span class="description"><?php _e('To Enable/Disable Follow feature from user profile','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
  		 ...
  		 <span class="description"><?php _e('To Display Online/Offline Status ','userpro'); ?></span>
		</td>
	</tr>
...
<h3><i class="userpro-icon-gears"></i><?php _e('Compatibility Settings','userpro'); ?></h3>
<table class="form-table">
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('Try playing with this setting If you encounter issues with viewing profile picture either on single site or multisite install. Play with this setting until your profile pictures appear.','userpro'); ?></span>
		</td>
	</tr>
		<tr valign="top">
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('Please switch off logging activity If you have host problems, your site crashes or cannot save a post, etc.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('If you use CDN or have a problem with thumbnails, try switching this option.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('If your host experience some problems when saving an external picture to your uploads directory, try to use the external method.','userpro'); ?></span>
		</td>
	</tr>
<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('Try playing with this setting If you encounter issues with twitter Login/Register.','userpro'); ?></span>
		</td>
	</tr>
...
<h3><i class="userpro-icon-gears"></i><?php _e('General','userpro'); ?></h3>
<table class="form-table">
	...
	<tr valign="top">
        ...
        <span class="description"><?php _e('If RTL is enabled then content will get display from right to left.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('User profiles permalink structure setting e.g. /profile/34 or /profile/Username or /profile/FirstName+LastName If you have a problem with permalink structure, you can try to change this setting.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('Ex.dd-mm-yy,mm-dd-yy,yy-dd-mm,yy-mm-dd','userpro'); ?></span>
		</td>
	</tr>
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('Enter custom field key to override default display name on profiles with this custom field value.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('A comma seperated list of custom fields to hide from profile view anyway.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('Should the verified account badge display beside name, or as a standard badge in badges.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('Should the verified badge link to a specific page?','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('Enter comma seperated list of user roles to publish automatically using the frontend publisher without waiting admin approval. e.g. author,subscriber,etc.'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('Lightbox for profile photos and other photo uploads. Turn on / off lightbox globally.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
        ...
        <span class="description"><?php _e('Enables webcam feature to take a profile picture using webcam','userpro'); ?></span>
		</td>
	</tr>
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('The maximum file size that user can upload whether it is a file, or a photo. e.g. <code>8388608 bytes = 8MB</code>','userpro'); ?></span>
		</td>
	</tr>
...
<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('This option will work only for multiselect categories selection','userpro'); ?></span>
		</td>
	</tr>
<tr valign="top">
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('The variables in {CURLY BRACKETS} are used to represent data and info in text. You can use them to customize your restricted content text.','userpro'); ?><?php userpro_admin_list_builtin_vars_restricted_content(); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('This option will provide conditional menu as per user\'s login condition. For eg: If user is logged in then it will not display the Login or Register menu in navigation menu and vice versa.' ,'userpro'); ?></span>
		</td>
	</tr>

</table>

<h3><i class="userpro-icon-picture"></i><?php _e('Appearance and Look','userpro'); ?></h3>
<table class="form-table">
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('To use a Google Web Font for UserPro plugin, enter the font family name here.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('To override Google font and force plugin to use theme font, or another built in font please enter font face here (e.g. Open Sans, Arial, etc)','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('A pixel or % width. If you want to make the plugin default width take 100% of its parent, just change this setting to 100% (It will take as much space as possible from the parent element). This option can be customized also via shortcode option <code>max_width</code>.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('This setting will work only with Default layout','userpro')?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('This controls the style of your profile thumbnails globally. If you let it default, these settings will be taken from your active skin.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('For translation compatibility, enter you "Light" heading color option here.','userpro'); ?></span>
		</td>
	</tr>
	
</table>

<h3><i class="userpro-icon-gears"></i><?php _e('Form Validation & Security','userpro'); ?></h3>
<table class="form-table">
<!--  Code comment by Ranjith to disable blocked users from setting -->
<!-- 	<tr valign="top">
		<th scope="row"><label for="blocked_users"><?php //_e('Blocked Usernames / Addresses','userpro'); ?></label></th>
		<td>
			<textarea name="blocked_users" id="blocked_users" class="large-text userpro-largeblock"><?php //echo esc_attr(userpro_get_option('blocked_users')); ?></textarea>
			<span class="description"><?php //_e('A list of usernames and/or emails to block from accessing or logging in the site. Enter one username or email per line.','userpro'); ?></span>
		</td>
	</tr>
-->	
	<tr valign="top">
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('How many characters should be allowed if the above option is turned on.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('Enter a comma seperated list of field keys to include in the maximum field length validation.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('Enter a comma seperated list of field keys to automatically validate as a phone number field.','userpro'); ?></span>
		</td>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('The regex used to validate the phone number fields specified above, please do not change this unless you know what you are doing.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('Minimum many characters should be allowed if the above option is turned on.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('Enter a comma seperated list of field keys to include in the minimum field length validation.','userpro'); ?></span>
		</td>
	</tr>
	
</table>

<h3><i class="userpro-icon-edit"></i><?php _e('Profile Settings','userpro'); ?></h3>
<table class="form-table">
...
<?php
			...
			<span class="description"><?php _e('For example,If you want to some special role user has permission to edit users profile from front end then select these role.by default admin user can edit all users profile.','userpro'); ?></span>
		</td>
	</tr>
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('For example, If you do not want users to view other profiles but want to allow these special roles to always view profiles, including administrators.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('If you don\'t want to change role when user gets verified , select none in dropdown.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('e.g. Set a custom warning to any user profile for example: This account is for test purposes only, etc.','userpro'); ?></span>
		</td>
	</tr>
...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php printf(__('The panic key helps you access WP-admin screen If you enabled the hide backend setting below, and for some reason you cannot get back into your site. To enter your backend with the panic key use this URL: <strong>%s</strong>','userpro'), add_query_arg( 'userpro_panic_key', userpro_get_option('userpro_panic_key'), wp_login_url() ) ); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('By default, UserPro hides backend access from non-admins, however you can type a comma seperated list here of user roles to allow them to access the dashboard regardless of any other setting. example: author,editor','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('If set on, users backend will link to frontend profile view/edit. Turn off to allow backend user editing.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('If this is set to yes, author archives will be redirected to author profile pages automatically.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('You can redirect users to the built-in front-end pages by the plugin to hide backend access from them.','userpro'); ?></span>
		</td>
	</tr>
...
<h3><i class="userpro-icon-signin"></i><?php _e('Login Settings','userpro'); ?></h3>
<table class="form-table">
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('You can also redirect users to custom URL by passing <code>login_redirect</code> valid URL in your shortcode.','userpro'); ?></span>
		</td>
	</tr>
...
<h3><i class="userpro-icon-user"></i><?php _e('Registration Settings','userpro'); ?></h3>
<table class="form-table">
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('You can also redirect users to custom URL by passing <code>register_redirect</code> valid URL in your shortcode.','userpro'); ?></span>
		</td>
	</tr>
...
<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('New users will be assigned to this role automatically ones admin approv the user.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('New users will be assigned to this role automatically If you do not allow them to choose role.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('If you enable users to select their role, this option can limit allowed roles for user.','userpro'); ?></span>
		</td>
	</tr>
    ...
    <tr valign="top">
        ...
        <td>
            ...
            <span class="description"><?php _e('A comma seperated list of Email Domains to be allowed for registering on the website. Eg - @hotmail.com, @yahoo.com , leave it blank to allow all email domains','userpro'); ?></span>
        </td>
    </tr>
...
<h3><i class="userpro-icon-signout"></i><?php _e('Logout Page Settings','userpro'); ?></h3>
<table class="form-table">
...
<h3><i class="userpro-icon-lock"></i><?php _e('Password Settings','userpro'); ?></h3>
<table class="form-table">
...
<h3><i class="userpro-icon-facebook"></i><?php _e('Facebook Integration','userpro'); ?></h3>
<table class="form-table">
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('Open <a href="https://developers.facebook.com/apps">https://developers.facebook.com/apps</a> create a new app and edit its settings to make it work on your domain. In App Settings, please paste the App ID or API Key into this field.','userpro'); ?></span>
		</td>
	</tr>
	...
	<!-- Facebook Autopost Bring Back , Added By Rahul -->
		...
		<td>
			...
			<span class="description"><?php _e('When a user post a new post from frontend publisher, a post can be added automatically to his wall.','userpro'); ?></span>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('e.g. Check out this website!, Welcome to XX website, etc.','userpro'); ?></span>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('e.g. URL or small text that appears below the post name.','userpro'); ?></span>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('e.g. This is the main body of post which is displayed before the description of the wall post. e.g. Check out this great item and save 50%','userpro'); ?></span>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('This is the full description of the Facebook wall post.','userpro'); ?></span>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('The user will be taken to that URL address when they click on that post.','userpro'); ?></span>
		...
		<td>
			...
			<span class="description"><?php _e('When a user follows someone, a post can be added automatically to his facebook wall.','userpro'); ?></span>
...
<h3><i class="userpro-icon-linkedin"></i><?php _e('Linkedin Integration','userpro'); ?></h3>
<table class="form-table">
	...
	<tr valign="top">
		...
		<td>
         <input type="text" name="linkedin_app_key" id="linkedin_app_key" value="<?php echo userpro_get_option('linkedin_app_key'); ?>" class="regular-text" />
			<span class="description"><?php _e('Open <a href="https://www.linkedin.com/developer/apps">https://www.linkedin.com/developer/apps</a> create a new app and edit its settings to make it work on your domain. In App Settings, please paste the App ID or API Key into this field.','userpro'); ?></span>
	...
	<tr valign="top">
		...
		<td>
         <input type="text" name="instagram_app_key" id="instagram_app_key" value="<?php echo userpro_get_option('instagram_app_key'); ?>" class="regular-text" />
			<span class="description"><?php _e('Open <a href="http://instagram.com/developer/">http://instagram.com/developer/</a> create a new app and edit its settings to make it work on your domain. In App Settings, please paste the Client ID into this field.','userpro'); ?></span>
...
<h3><i class="userpro-icon-twitter"></i><?php _e('Twitter Integration','userpro'); ?></h3>
<table class="form-table">
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('You must first create an app at <a href="https://dev.twitter.com/apps/">https://dev.twitter.com/apps/</a> and enter your consumer keys to enable twitter connect.','userpro'); ?></span>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description"><?php _e('When they first connect to your site.','userpro'); ?></span>
		</td>
	</tr>
...
<h3><i class="userpro-icon-google-plus"></i><?php _e('Google Integration','userpro'); ?></h3>
<table class="form-table">
...
<!-- *** Commented by Madhulika add to new tab *** -->
<!--<h3><i class="userpro-icon-envelope-alt"></i><?php _e('MailChimp Settings','userpro'); ?></h3>
<table class="form-table">

	<tr valign="top">
		<th scope="row"><label for="mailchimp_api"><?php _e('MailChimp API Key','userpro'); ?></label></th>
		<td>
			<input type="text" name="mailchimp_api" id="mailchimp_api" value="<?php echo userpro_get_option('mailchimp_api'); ?>" class="regular-text" />
			<span class="description"><?php _e('Enter your MailChimp API key here to allow integration with MailChimp subscription.','userpro'); ?></span>
		</td>
	</tr>

</table>
<h3><i class="userpro-icon-envelope-alt"></i><?php _e('Aweber Settings','userpro'); ?></h3>
<table class="form-table">
<tr valign="top">
		<th scope="row"><label for="Aweber_api"><?php _e('Aweber Authorization Code','userpro'); ?></label></th>
		<td>
			<input type="text" name="aweber_api" id="authorization_code" value="<?php echo userpro_get_option('aweber_api'); ?>" class="regular-text" />
			<span class="description"><?php _e('Enter your Aweber Authorization Code here to allow integration with Aweber subscription.','userpro'); ?></span>
<a target="_blank" href="https://auth.aweber.com/1.0/oauth/authorize_app/f49b1bcf">Click Here</a> to get.
		  			
		</td>
		</tr>
		<tr valign="top">
		<th scope="row"><label for="Aweber_listid"><?php _e('Aweber List Id','userpro'); ?></label></th>
		<td>
			<input type="text" name="aweber_listname" id="aweber_listname" value="<?php echo userpro_get_option('aweber_listname'); ?>" class="regular-text" />
		</td>
	</tr>

</table>
<h3><i class="userpro-icon-envelope-alt"></i><?php _e('Campaignmonitor Settings','userpro'); ?></h3>
<table class="form-table">

	<tr valign="top">
		<th scope="row"><label for="Campaignmonitor_api"><?php _e('Campaignmonitor Authorization Code','userpro'); ?></label></th>
		<td>
			<input type="text" name="Campaignmonitor_api" id="Campaignmonitor_code" value="<?php echo userpro_get_option('Campaignmonitor_api'); ?>" class="regular-text" />
			<span class="description"><?php _e('Enter your Campaignmonitor Authorization Code here to allow integration with Campaignmonitor subscription.','userpro'); ?></span>
		</td>
		</tr>
		<tr valign="top">
		<th scope="row"><label for="Campaignmonitor_listname"><?php _e('Campaignmonitor List Name','userpro'); ?></label></th>
		<td>
			<input type="text" name="Campaignmonitor_listname" id="Campaignmonitor_listname" value="<?php echo userpro_get_option('Campaignmonitor_listname'); ?>" class="regular-text" />
		</td>
	</tr>

</table>-->
<h3><i class="userpro-icon-gears"></i><?php _e('BuddyPress Compatibility','userpro'); ?></h3>
<table class="form-table">
