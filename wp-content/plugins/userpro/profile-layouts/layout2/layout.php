...
?>  
      ...
      <div class="container" id="main_section">
           ...
           <div class="row upl-overlay">
                         ...
                         <div class="col-lg-12 col-xs-12" id="upl-header-bg" style="background-image:url(<?php echo $background_pic;?>);">
                         ...
                         <div class="upl-profilepic">
                                ...
                                <div class="userpro-profile-img img-circle" data-key="profilepicture"><a href="<?php echo $userpro->profile_photo_url($user_id); ?>" class="userpro-tip-fade lightview" data-lightview-caption="<?php echo $userpro->profile_photo_title( $user_id ); ?>" title="<?php _e('View member photo','userpro'); ?>"><?php echo get_avatar( $user_id, $profile_thumb_size ); ?></a></div>
                                <?php } ?>
                            </div>
          ...
          <div class="row upl-count-bg">
                   ...
                   <div class="col-lg-4 col-lg-offset-4 col-sm-4 col-xs-4 connect">
                        ...
                        <span class="upl-number-conn"><?php echo str_ireplace('following','',$userpro_social->following_count( $user_id )); ?></span><br>
                        <a href="<?php echo $userpro->permalink($user_id, 'following', 'userpro_sc_pages'); ?>" class="userpro-count-link" style="color:white !important"><?php _e('FOLLOWING','userpro') ?></a>
                   </div>
                
                 <div class="col-lg-4 col-lg-offset-4 col-sm-4 col-xs-4 connect">
                      
                        <span class="upl-number-conn"><?php echo str_ireplace('followers','',$userpro_social->followers_count( $user_id )); ?></span><br>
                        
                        <a href="<?php echo $userpro->permalink($user_id, 'followers', 'userpro_sc_pages'); ?>" class="userpro-count-link" style="color:white !important"><?php _e('FOLLOWERS','userpro') ?></a>
                   </div>
                 <div class="col-lg-4 col-lg-offset-4 col-sm-4 col-xs-4 connect">
                     <span class="upl-number-conn"><?php echo str_ireplace('connections','', $userpro->connetions_count($user_id)); ?></span><br>
<!--                         <a href="< ?php echo $userpro->permalink($user_id, 'connection', 'userpro_sc_pages'); ?>" class="userpro-count-link" style="color:white !important">< ?php _e('CONNECTIONS','userpro');?></a>-->
                            <a href="<?php echo $userpro->permalink($user_id, 'connections','userpro_connections'); ?>" class="userpro-count-link" style="color:white !important"><?php _e('CONNECTIONS','userpro');?></a></div>
                   </div>
           ...
           <div class="row" style="margin-top: 4%">
                                 ...
                                 <div class="col-lg-4 col-sm-8 col-xs-12 profile-name">
                                        <h3><a href="<?php echo $userpro->permalink($user_id); ?>"><?php echo userpro_profile_data('display_name', $user_id); ?></a></h3>
                                        <hr class="h_line">
...
<!--                       <img src="< ?php echo userpro_url.'profile-layouts/layout'.$layout.'/images/review.png' ?>" /><a href="<?php echo $userpro->permalink($user_id, 'rating','userpro_rating'); ?>" class="userpro-count-link" ><span>View Reviews</span></a> <a href="<?php echo $userpro->permalink($user_id, 'rating', 'userpro_sc_pages'); ?>" class="userpro-count-link" ><span>View Reviews</span></a>-->
                        <?php }?>
			...
			$res .= '<a href="'.userpro_link_filter( userpro_profile_data($key, $user_id), $key ).'" class="userpro-profile-icon-upl userpro-tip" title="'.$array['label'].'" target="'.$args['social_target'].'" ><img src="'.userpro_url.'profile-layouts/layout'.$layout.'/images/'.$key.'_icon.png" /></a>';
			}
                    }
